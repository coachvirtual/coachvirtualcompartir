...
const FAQ_DATA = [
    {
        ...
        a: 'Ve a <a href="https://www.edi.santillanacompartir.com.co/" target="_blank" class="text-indigo-400 underline">edi.santillanacompartir.com.co</a> y haz clic en <strong>"¿Olvidaste tu contraseña?"</strong>. Recibirás un correo de recuperación. Si no llega, revisa la carpeta de spam o contáctanos.'
    },
    {
        q: '¿Por qué no carga el Libro Web?',
        a: 'Puede ser un problema de caché. Intenta: (1) Limpiar el caché del navegador, (2) Usar Chrome o Edge actualizados, (3) Desactivar extensiones del navegador. Si el problema persiste, contáctanos.'
    },
    {
        q: '¿Dónde veo las tareas asignadas por mi docente?',
        a: 'En la plataforma, haz clic en el ícono de <strong>Tareas</strong> (esquina superior derecha). Allí verás las tareas pendientes y entregadas. También puedes entrar a cada clase y revisar el apartado de Actividades.',
        video: 'XugiPvcc20g'
    },
    {
        q: '¿Cómo ingreso a Richmond Studio (inglés)?',
        a: 'Puedes ingresar desde <strong>Santillana Connect</strong> o desde <strong>EDI Santillana</strong>. Busca el ícono de Richmond Studio en tu plataforma.',
        video: 'P9ohgrwD_zs'
    },
    {
        q: '¿Cómo creo una evaluación en Pleno?',
        a: 'Ingresa a Pleno desde EDI Santillana, selecciona la asignatura, haz clic en <strong>"Nueva evaluación"</strong> y elige si usas el banco de Santillana o creas tus propias preguntas.',
        video: 'DdPnWYVu1y4'
    },
    {
        q: '¿En qué navegador funciona mejor la plataforma?',
        a: 'Se recomienda <strong>Google Chrome</strong> o <strong>Microsoft Edge</strong> en sus versiones más recientes. Evita Internet Explorer. En móvil, Chrome para Android o Safari para iPhone funcionan bien.'
    }
];
